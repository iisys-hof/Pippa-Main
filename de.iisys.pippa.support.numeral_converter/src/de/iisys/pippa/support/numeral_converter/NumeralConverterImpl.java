...
/**
 * Taken from: https://github.com/jgraham0325/words-to-numbers
 * under MIT-license
 */
...
public class NumeralConverterImpl implements NumeralConverter{
	 ...
	 * @param inputText
	 */
	private String convertTextualNumbersInDocument(String inputText) {
	 ...
	 * @return
	 */
	private List<String> replaceTextualNumbers(List<String> words) {
	 ...
	 * @return
	 */
	private String retainPunctuation(List<String> processingList, String wordAsDigits) {
	 ...
	 * @return
	 */
	private List<String> cleanAndTokenizeText(String sentence) {
	 ...
	 * @return
	 */
	private String wordListToString(List<String> list) {
	 ...
	 * @return
	 */
	private long convertWordsToNum(List<String> words) {
		long finalResult = 0;
	...
	@Override
	public String numeralsToNumbers(String input) {

		return this.convertTextualNumbersInDocument(input);
	}
